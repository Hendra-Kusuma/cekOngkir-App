...
@section('content')
    <div class="container">
        <div class="ongkir-header text-center">
            <h1>CodeOngkir</h1>
            <p class="lead">Project Cek Ongkir ke Seluruh Kota dan Kabupaten di Indonesia</p>
        </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="origin_province">Provinsi</label>
